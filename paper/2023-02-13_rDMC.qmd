...
```{r}
#| label: dendrogram
#| fig-cap: "Description of the disaggregated technology categories used to compute the distribution of military capabilities."
#| fig.width: 8
#| fig.height: 10
...
## US and China Polarity

@brooks_risefallgreat_2016 argue that the distribution of capabilities is evidence that the US will remain the world's sole superpower and China is far behind militarily. There has been a big debate over this, but that only demonstrates the importance of the claim [@christensen_chinachallengeshaping_2015; @beckley_emergingmilitarybalance_2017; @gilli_whychinahas_2019]. When it comes to measuring the distribution of power, their 3 material elements are military, economic, and technological capacity. They agree that military spending is not a great measure because it doesn't tell us about short-term and immediate capabilities, so they use the command of the commons concept developed by @posen_commandcommonsmilitary_2003 and disaggregate the four components sea (nuclear powered submarines, aircraft carriers, cruisers and destroyers, and principal amphibious ships), space (operating satellites and military satellites), air (heavy UAVs, 4th generation tactical aircraft, 5th generation tactical aircraft, attack helicopters), and infrastructure (airborne early warning and EWAC airacraft, tanker and tanker/transport aircraft, heavy/medium transport helicopters, heavy/medium transport aircraft).

BW's point is on this measure, the US is far beyond anyone else (as of 2014) and when compared to China the US is still super far ahead. "The key takeaway is that compared to any previous era except the years between 1991 and the early 2000s, the overall gap in the military realm remains unprecedented in modern international relations" (p 22). They ignore the quality difference and also nukes, so I can do that too
...
```{r}
#| label: china-static
#| fig-cap: "Replication of Brooks and Wohlforth (2016)"
#| fig-pos: 'h'
#| fig-height: 10
#| fig-width: 7
...
```{r}
#| label: china-timeseries
#| fig-cap: "US-China share over time"
#| fig-pos: 'h'
#| fig-height: 8
#| fig-width: 8
...
commons_all %>%
  ...
  dplyr::mutate(domain = dplyr::recode(domain,
                ...
                capability = dplyr::recode(capability,
                                           'nuclear powered submarines' = "Subs",
                                           'aircraft carriers' = "Carriers",
                                           'cruisers and destroyers' = "Cruisers/Destroyers",
                                           'principal amphibious ships'= "Amphib",
                                           'heavy uavs' = "UAV",
                                           '4th generation tactical aircraft' = "4th gen aircraft",
                                           '5th generation tactical aircraft' = "5th gen aircraft",
                                           'attack helicopters' = "Attack heli",
                                           'operating satellites' = "Operating",
                                           'military satellites' = "Military",
                                           'airborne ew and control' = "AEW&C",
                                           'tankers' = "Tankers",
                                           'heavy/ medium transport helicopters' = "Transport heli",
  ...
  ggplot(aes(x = year,
             ...
             fill = capability,
             label = capability)) +
  geomtextpath::geom_textsmooth(hjust = 1,
                                method = "loess",
                                color = "lightblue") +
  geom_smooth(aes(group = domain), method = "loess") +
  geomtextpath::geom_texthline(yintercept = 0,
                               label = "Parity", 
                               linetype = 2,
                               size = 3) +
  ...
  theme(text = element_text(size = 14),
        ...
        axis.title.x = element_blank()) +
  labs(title = "Command of the Commons",
       subtitle = "Gap Between US and China Share of Capabilities",
       y = "US-China Balance of Capabilities")
```
