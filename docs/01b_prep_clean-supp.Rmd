...
# Drop troops
iiss <- iiss[!iiss$unit_name == "troops", ]
```
...
iiss$equipment_name[iiss$equipment_name == "COMD"] <- "C2"
iiss_ac_match <- iiss %>%
...
iiss$equipment_name[iiss$equipment_name == "SP how"] <- "SP/HOW"
...
iiss$equipment_type[iiss$equipment_type == "Mortars"] <- "artillery"
...
iiss$equipment_subtype[iiss$equipment_name == "GUNS/HOW"] <- "GUNS/HOW"
iiss$equipment_name[iiss$equipment_name == "GUNS/HOW"] <- NA
...
iiss$equipment_name[iiss$unit_name == "Mi-24" &
...
iiss$equipment_type[iiss$equipment_type == "patrol craft"] <- "patrol and coastal combatants"
...
# Minor surface combatants
iiss$equipment_type[iiss$equipment_type == "Minor surface combatants"] <- "patrol and coastal combatants"
...
iiss <- iiss %>%
  dplyr::filter(!(equipment_type == "principal surface combatants" & equipment_name == "SAM"))

iiss <- iiss %>%
  dplyr::filter(!(equipment_type == "principal surface combatants" & unit_name == "ASROC"))
...
iiss <- iiss %>%
  dplyr::filter(!(equipment_type == "unmanned aerial vehicles" & equipment_name == "UAV" & unit_name == "(trials)"))

iiss <- iiss %>%
  dplyr::filter(!(unit_name == "trials" & equipment_type == "surface-to-surface missile launchers"))

iiss <- iiss %>%
  dplyr::filter(!(unit_name == "sqns" |
                  unit_name == "ac" |
                  unit_name == "hel"))

iiss <- iiss %>%
  dplyr::filter(!unit_name == "Sea Dart")

iiss <- iiss %>%
  dplyr::filter(!((equipment_name == "FFG" | equipment_name == "FFGHM") & equipment_type == "surface-to-surface missile launchers"))

iiss <- iiss %>%
  dplyr::filter(!(equipment_name == "TRIALS" & equipment_type == "surface-to-surface missile launchers"))

iiss <- iiss %>%
  dplyr::filter(!(equipment_type == "battalion"))

iiss <- iiss %>%
  dplyr::filter(!(unit_name == "Mk46"))

iiss <- iiss %>%
  dplyr::filter(!(equipment_type == "helicopters" & equipment_name == "LPH" & (unit_name == "Helicopter" | unit_name == "Helicopter Support")))
