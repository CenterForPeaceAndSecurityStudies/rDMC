...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("artillery_anti-aircraft_AA" = "air defence_NA_AA"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("anti-tank/anti-infrastructure_NA_AA" = "air defence_NA_AA"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("air defence_MOR_NA" = "artillery_MOR_NA"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("air defence_RCL_NA" = "artillery_RCL_NA"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("air defence_NA_AShM	" = "land/sea defence_NA_AShM	"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("air defence_NA_EW" = "radars_NA_EW"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("anti-tank/anti-infrastructure_NA_RECCE" = "armoured fighting vehicles_NA_RECCE"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("anti-tank/anti-infrastructure_RCL_RECCE	" = "armoured fighting vehicles_RCL_RECCE"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("anti-tank/anti-infrastructure_RL_RECCE	" = "armoured fighting vehicles_RL_RECCE"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("logistics and support_NA_FFG$" = "principal surface combatants_frigates_NA"))

df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("logistics and support_NA_SSA$" = "submarines_NA_SSA"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("logistics and support_NA_SSAN$" = "submarines_NA_SSAN"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_ACV" = "logistics and support_NA_ACV"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AEF" = "logistics and support_NA_AEF"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AFS" = "logistics and support_NA_AFS"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AG" = "logistics and support_NA_AG"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AGHS" = "logistics and support_NA_AGHS"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AOT" = "logistics and support_NA_AOT"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AOR" = "logistics and support_NA_AOR"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AR" = "logistics and support_NA_AR"))
...
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AVT" = "logistics and support_NA_AVT"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_AK" = "logistics and support_NA_AK"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_fleet replenishing ships" = "logistics and support_NA_fleet replenishing ships"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_icebreakers_NA" = "logistics and support_icebreakers_NA"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_repair" = "logistics and support_NA_repair"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_SAR" = "logistics and support_NA_SAR"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_Survey" = "logistics and support_NA_Survey"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_tankers" = "logistics and support_NA_tankers"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_trials/research" = "logistics and support_NA_trials/research"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_VTB" = "logistics and support_NA_VTB"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_WTGB" = "logistics and support_NA_WTGB"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_YDT" = "logistics and support_NA_YDT"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_YTB" = "logistics and support_NA_YTB"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_YDT" = "logistics and support_NA_YDT"))
df$tek_aggreg <- str_replace_all(df$tek_aggreg, c("patrol and coastal combatants_NA_YP" = "logistics and support_NA_YP"))
